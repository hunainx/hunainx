...
<picture>
  ...
  <img src="assets/hero/hero-light.svg" alt="Hunain Ahmed — AI · Software · Products — Turning ambiguous problems into products, intelligent systems and working software. — MCP · Cloud Run · PostgreSQL + pgvector · Supabase · Retrieval · Interactive web · Automation">
</picture>
</p>
<!-- END:hero -->
...
<sub>Currently an AI Specialist, building evidence-intelligence infrastructure.</sub>
<!-- END:about -->
...
<picture>
  ...
  <img src="assets/labels/motion-light.svg" alt="$ ./in-motion">
</picture>
</p>
...
<picture>
  ...
  <img src="assets/motion/01-light.svg" alt="01. AI infrastructure. Evidence intelligence platform: Ingestion, OCR, transcription and vector retrieval for litigation-scale document archives, served to AI through MCP servers on Cloud Run · Status: In active use. Confidential. Stack: Google Cloud Run, Google Cloud Storage, Supabase, PostgreSQL, pgvector, MCP, Claude.">
</picture>
<picture>
  ...
  <img src="assets/motion/02-light.svg" alt="02. Product. Airo Rentals booking platform: Live availability, scheduling and an admin console, built on the self-drive rental site · Stack: Supabase, PostgreSQL, GSAP.">
</picture>
<a href="https://rumergroups.com"><picture>
  ...
  <img src="assets/motion/03-light.svg" alt="03. Interactive web. Rumer Groups: Corporate website, specified in a 25,000-word PRD, built with AI-accelerated implementation and audited P0 to P3 before launch · Status: Live. Stack: GSAP + ScrollTrigger, WebGL2, Netlify. Link: rumergroups.com.">
</picture></a>
<picture>
  ...
  <img src="assets/motion/04-light.svg" alt="04. Product strategy. AURA — A hardware product concept taken through adversarial validation covering market, feasibility, regulation and the smallest viable version · Status: Concept. Stack: Market, Feasibility, Regulation, MVP.">
</picture>
</p>
<!-- END:motion -->
...
<picture>
  ...
  <img src="assets/labels/stack-light.svg" alt="$ tree ./stack">
</picture>
</p>
...
<picture>
  ...
  <img src="assets/stack/stack-light.svg" alt="Depth: AI toolkit: Claude, Claude Code, Claude Desktop, MCP, Google Antigravity, Gemini; Cloud: Google Cloud Run, Google Cloud Storage; Data &amp; retrieval: PostgreSQL, pgvector, Supabase, OCR, Transcription; Interactive web: GSAP + ScrollTrigger, WebGL2; Automation &amp; delivery: GitHub Actions, Netlify. Range: AI infrastructure, Products &amp; SaaS, Interactive web, Data &amp; retrieval, Automation, Product strategy, Creative technology.">
</picture>
</p>
<!-- END:stack -->
...
<picture>
  ...
  <img src="assets/dividers/rule-light.svg" alt="Divider">
</picture>
</p>
